...
function attributes_to_scale(e::Edge)
    return [:capacity_size, :existing_capacity, :fixed_om_cost, :investment_cost, :cumulative_capacity_init, :max_capacity, :cumulative_external_capacity, :max_new_capacity,:max_new_capacity_init, :min_capacity, :variable_om_cost]
end

function attributes_to_scale(e::EdgeWithUC)
    return [:capacity_size, :existing_capacity, :fixed_om_cost, :investment_cost, :cumulative_capacity_init, :max_capacity, :max_new_capacity, :max_new_capacity_init, :cumulative_external_capacity, :min_capacity, :variable_om_cost, :startup_cost]
end

function attributes_to_scale(g::AbstractStorage)
    return [:capacity_size,:existing_capacity,:fixed_om_cost,:investment_cost, :cumulative_capacity_init, :cumulative_external_capacity, :max_capacity, :max_new_capacity, :max_new_capacity_init, :min_capacity]
end
